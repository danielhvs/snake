...
public class MovingRulesTest {
	...
	public void move_DefaultDirection_MovesTheSnakeToTheRight() throws Exception {
		AMovingRules rules = new MovingRules(new Snake(0, 0), new Point(1, 0)).move();

		assertEquals(new MovingRules(new Snake(1, 0), new Point(1, 0)), rules);
	}

	@Test
	public void turnLeftThenMove_MovesTheSnakeUp() throws Exception {
		AMovingRules rules = new MovingRules(new Snake(0, 0), new Point(1, 0)).turnLeft().move();
	...
	public void turnRightThenMove_MovesTheSnakeDown() throws Exception {
		AMovingRules rules = new MovingRules(new Snake(0, 0), new Point(1, 0)).turnRight().move();
	...
	public void turnLeftAndMove_ManyTimes_MovesTheSnakeAsExpected() throws Exception {
		AMovingRules rules = new MovingRules(new Snake(3, 0), new Point(1, 0)).turnLeft().move().turnLeft().move().turnLeft().move();
